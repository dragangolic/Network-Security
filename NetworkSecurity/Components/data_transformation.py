...
class DataTransformation:
    ...
    def get_data_transformation_object(cls) -> Pipeline:
        '''
        It initializes a KNNImputer object with the parameters specified in the 
        ...
        A Pipeline object
        '''
        logging.info("Enter get_data_transformation_object method of Transformation class")
        try:
    ...
    def initiate_data_transformation(self)-> DataTransformationArtifact:
        logging.info("Entered initiate.. method of DataTransformation class")
        try:
            ...
            data_transformation_artifact = DataTransformationArtifact(
                ...
                transformation_train_file_path = self.data_transformation_config.transformation_train_file_path,
                transformation_test_file_path = self.data_transformation_config.transformation_test_file_path,
            )
